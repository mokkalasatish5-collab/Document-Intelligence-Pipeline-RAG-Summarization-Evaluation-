...
class DocumentQAApp:
    ...
    def run(self):
        ...
        self.selected_language = st.sidebar.selectbox("Choose a language / Wählen Sie eine Sprache aus:",
                                                      ["English", "German"])
        ...
        self.selected_task = st.sidebar.radio("Select a task / Wählen Sie eine Aufgabe aus:",
                                              [ui_texts["task_option_chatbot"], ui_texts["task_option_summarization"]])
            ...
            if uploaded_images:
                for uploaded_image in uploaded_images:
                    ...
                    if uploaded_image.name.lower().endswith(('.png', '.jpg', '.jpeg')):
                        ...
                        if ocr_result:
                            st.sidebar.success(
                                f"OCR performed on '{uploaded_image.name}' and text saved as '{os.path.basename(ocr_result)}'")
